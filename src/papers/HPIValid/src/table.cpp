...
Table::Table(const std::filesystem::path& path) {
  ...
  // bt::cpu_timer timer_readingAndPreconversion;
...
void Table::splitLine(std::vector<std::string>& strvec,
...
void Table::writeToFile(const std::filesystem::path& path) const {
