...
dist_skew_normal_t::dist_t dist_skew_normal_t::get_dist(const dist_param_t& x) {
  double l_xi = 0;
  double l_omega = 0;
  double l_alpha = 0;
...
double dist_skew_normal_t::mean() const {
...
double dist_skew_normal_t::std_dev() const { return std::sqrt(variance()); }

double dist_skew_normal_t::variance() const {
  // const double l = _dist.location();
  const double s = _dist.scale();
  // const double a = _dist.shape();
  const double d = delta();
...
double dist_skew_normal_t::skewness() const {
  // const double l = _dist.location();
  // const double s = _dist.scale();
  // const double a = _dist.shape();
  const double d = delta();
  ...
  return (((double{4} - M_PI) / double{2}) *
          (((d * f) * (d * f) * (d * f)) /
           std::pow((1 - 2 * d * d / M_PI), double{3} / double{2})));
}

double dist_skew_normal_t::ex_kurtosis() const {
  // const double l = _dist.location();
  // const double s = _dist.scale();
  // const double a = _dist.shape();
  const double d = delta();
...
double dist_skew_normal_t::delta() const {
  // const double l = _dist.location();
  // const double s = _dist.scale();
  const double a = _dist.shape();
