...
double fLogFactorial(double x) { return std::lgamma(x + 1); }
...
double fBinomGamma(double n, double k) {
  ...
  return floor(
      0.5 + exp((fLogFactorial(n) - fLogFactorial(k)) - fLogFactorial(n - k)));
}
double fLogBinomGamma(double n, double k) {
  if (k <= 0.000001) {
    return 0.0;
  }
...
double dihrLower(double k, double n, double m) {
  const double B = n / m;
  if (k > (n - B)) return m;
...
void querytemplate_t::set(int i) {
  switch (i) {
    case 1:
      set_1();
      break;
...
std::string querytemplate_t::to_string() const {
  std::string lRes;
...
std::ostream& queryinstance_t::print_param(std::ostream& os,
                                           const querytemplate_t& x,
                                           const int w) const {
  os << std::setw(w) << a();
...
std::ostream& queryinstance_t::print_query(std::ostream& os,
                                           const querytemplate_t& x) const {
  print_select(os, x);
...
std::ostream& queryinstance_t::print_select(std::ostream& os,
                                            const querytemplate_t& x) const {
  os << "select ";
  os << a();
  if (kPredRg == x.pred_having_aggr()) {
...
std::ostream& queryinstance_t::print_where(std::ostream& os,
                                           const querytemplate_t& x) const {
  if (kNoPred != x.pred_where()) {
...
std::ostream& queryinstance_t::print_having(std::ostream& os,
                                            const querytemplate_t& x) const {
  os << "      having " << to_string_aggr(x.aggr_having()) << "(l_quantity)";
