...
void construct_arg_desc(argdesc_vt& x) {
  ...
  x.push_back(new barg_t("--trace", false, &Cb::trace,
                         "trace estimation, print single results"));
  x.push_back(new barg_t("-t", false, &Cb::trace,
                         "trace estimation, print single results"));
  x.push_back(new barg_t("-b", false, &Cb::printBad,
                         "print bad estimates with q-error > limit (see -q)"));
  x.push_back(new barg_t("-i", 0, &Cb::isUiDense,
                         "assume attribute B is unsigned integer and dense"));
  x.push_back(new barg_t("-c", 0, &Cb::calcMeanVar,
                         "calculate mean/variance for uniform dist"));
